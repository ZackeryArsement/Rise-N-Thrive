...
const Game = ({
    ...
    return (
        <div className={classes.gameTab} style={{ backgroundColor: theme }}>
            {games &&
                games.map((game)=> (
                        <div className={game.title === 'Lil\' Penguin' ? (`${classes.container} ${classes.penguin}`) : (classes.container) } style={theme === "#393939"
